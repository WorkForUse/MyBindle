...
import MobileImage3 from '../public/images/MobileImage3.png';
import MobileImageFourth from '../public/images/MobileImageFourth.png';
  ...
  return (
    <>
      <div className="SprConn">
        <div>
          <img src={MobileImageSecond} alt="Mobile Image Second" />
        </div>
      ...
      <div className="hwAPP text-center">
        ...
        {/* Steps */}
        <div className="grid grid-cols-3 gap-4 rounded-lg ml-10 mr-10 mt-3 mb-3">
          <div className="text-black shadow-lg p-5">
            <h3 className="font-bold mb-5">Download</h3>
            <p>Open Play Store or App Store</p>
          </div>

          <div className="text-black shadow-lg rounded-lg ml-8 mr-8 mt-3 mb-3">
        ...
        <div className="dnBn rounded-lg">
          ...
          <div className="abs-2">
            <img src={MobileImageFourth} alt="Mobile Image Fourth" />
          </div>
        </div>
      </div>
    </>
